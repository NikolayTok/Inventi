          ...
          return (
            <li key={post.id} className='border rounded p-4 mb-4'>
              <div className='flex items-center gap-4 text-bold text-[2rem] relative'>
                ...
                <span className='absolute text-[1rem] top-[-10px] right-[-7px]'>
                  {post.id}
                </span>
              </div>
             ...
             text-[#000000c9]'
                ...
                <button
                  className='transition text-center text-white block p-4 bg-red-500 hover:bg-black rounded
             text-[#000000c9]'
                  onClick={() => dataContext?.deletePost(post.id)}
                >
                  Delete
                </button>
              </div>
